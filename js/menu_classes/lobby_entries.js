...
import { allLobbyEntries } from "../menu_modules/lobby_content.js";
import { getLocalizedString } from "../menu_modules/menu_localization.js";

export class LobbyWindow {
  id = "default_lobby";
  idSel;
  ...
  updateSelection(newSelection) {
    ...
    this.currentCategory = this.lobbyCategories.list[this.currentCategoryIndex];
...
export class LobbyEntry extends MenuEntryList {
  isMenuColor = false;
